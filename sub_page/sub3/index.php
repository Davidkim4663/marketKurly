...
<head>
    ...
    <title>알뜰쇼핑</title>
    <link rel="stylesheet" href="<?=$current_path?>css/sub3.css">
...
<body>
    ...
    ?>
     <main id="main">
        <section id="section1">
            <div class="container">
                <a href="#">
                    <img src="./img/yOqRauHQsdbhruZnJJvmASFPYs1gdPARHI9KCt7K.jpg" alt="">
                </a>
            </div>
        </section>
        <section id="section2">
                    ...
                    <div class="left">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <div class="sub sub2">
                                    <ul>
                                        <li><label for="sub2ChkBtn01"><input type="checkbox" id='sub2ChkBtn01' name='sub2_chk_btn01' value='경주천년한우'>경주천년한우</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn02"><input type="checkbox" id='sub2ChkBtn02' name='sub2_chk_btn02' value='고기대신'>고기대신</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn03"><input type="checkbox" id='sub2ChkBtn03' name='sub2_chk_btn03' value='곤트란 쉐리에'>곤트란 쉐리에</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn04"><input type="checkbox" id='sub2ChkBtn04' name='sub2_chk_btn04' value='광화문 미진'>광화문 미진</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn05"><input type="checkbox" id='sub2ChkBtn05' name='sub2_chk_btn05' value='그녀의 빵공장'>그녀의 빵공장</label><i>2</i></li>
                                        <li><label for="sub2ChkBtn06"><input type="checkbox" id='sub2ChkBtn06' name='sub2_chk_btn06' value='그리너스'>그리너스</label><i>3</i></li>
                                        <li><label for="sub2ChkBtn07"><input type="checkbox" id='sub2ChkBtn07' name='sub2_chk_btn07' value='기와'>기와</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn08"><input type="checkbox" id='sub2ChkBtn08' name='sub2_chk_btn08' value='김구원선생'>김구원선생</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn09"><input type="checkbox" id='sub2ChkBtn09' name='sub2_chk_btn09' value='나뚜루'>나뚜루</label><i>1</i></li>
                                        <li><label for="sub2ChkBtn10"><input type="checkbox" id='sub2ChkBtn10' name='sub2_chk_btn10' value='내추럴키티'>내추럴키티</label><i>2</i></li>
                                    </ul>
    ...
    <script src="<?=$current_path?>js/sub3_script.js"></script>
